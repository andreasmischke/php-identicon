...
// Settings
define('MARGIN_X', 35);        // Margin on the left and right edge in px
define('MARGIN_Y', 35);        // Margin on the upper and lower edge in px
define('BOX_SIZE_W', 70);      // Width of the individual "pixels" in px
define('BOX_SIZE_H', 70);      // Height of the individual "pixels" in px
...
$col = imagecolorallocate($im, 181, 230, 29);
